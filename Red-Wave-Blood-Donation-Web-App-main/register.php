  ...
  <?php include 'header.php'; ?>
    ...
    <div class="tab-content">
       ...
       <div class="tab-pane container active" id="hospitals">
        ...
        <form action="file/hospitalReg.php" method="post" enctype="multipart/form-data" class="myForm">
       ...
       <div class="tab-pane container fade" id="receivers">
         ...
         <form action="file/receiverReg.php" method="post" enctype="multipart/form-data" class="my_Form">
...
<script type="text/Javascript">
    ...
    function showPosition(position){
        document.querySelector('.myForm input[name = "hlatitude"]').value = position.coords.latitude;
        document.querySelector('.myForm input[name = "hlongitude"]').value = position.coords.longitude;
        document.querySelector('.my_Form input[name = "rlatitude"]').value = position.coords.latitude;
        document.querySelector('.my_Form input[name = "rlongitude"]').value = position.coords.longitude;
    }
