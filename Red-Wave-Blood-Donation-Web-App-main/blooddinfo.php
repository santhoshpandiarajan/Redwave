    ...
    <div class="container cont">
      ...
      <div class="row justify-content-center">
        ...
        <form action="file/infoAddd.php" method="post">
          ...
          <label class="text-muted font-weight-bold">Select Group</label>
          ...
          <label class="text-muted font-weight-bold">User Phone No for Selected Group</label>
					<input type="text" name="bphone" placeholder="Enter the User Phone No" class="form-control mb-3" required>
