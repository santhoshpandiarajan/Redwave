...
if(isset($_POST['rregister'])){
	...
	$sql = "INSERT INTO receivers (rname, remail, rpassword, rphone, rbg, rcity, rlatitude, rlongitude)
	VALUES ('$rname','$remail', '$rpassword', '$rphone', '$rbg', '$rcity', '$rlatitude', '$rlongitude')";
