...
<script>
    ...
    function showPosition(position){
        var latitude = document.querySelector('input[name = "latitude"]').value = position.coords.latitude;
        var longitude = document.querySelector('input[name = "longitude"]').value = position.coords.longitude;
